            ...
            >
                ...
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-[#E8491C] uppercase tracking-widest mb-1">Supra v.</p>
                        <p className="text-xs font-medium text-white">Projet</p>
                    </div>
                </div>
            </motion.div>
        </motion.div>
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-gray-500 max-w-xl leading-relaxed">
                        Branding, contenus, sites web, campagnes Meta Ads et automatisation IA à Marrakech. <br className="hidden md:block" />
                        Des projets pensés pour créer de la visibilité, des leads et du temps gagné.
                    </p>
                </motion.div>
                ...
                <div className="relative flex items-center justify-center w-full h-full">
                    {IMAGES.slice(0, TOTAL_IMAGES).map((src, i) => {
                        ...
                        if (introPhase === "scatter") {
                            ...
                            const maxRotation = spreadAngle * 0.46; // Keep the final arc composed inside the viewport
