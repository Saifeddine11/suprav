...
const seo = {
  title: 'À Propos de Supra v. — Agence de communication Marrakech',
  description: 'Découvrez l\'équipe Supra v., agence de communication 360° à Marrakech. Branding, sites web, contenus, IA. Notre histoire, nos valeurs, notre méthode.',
  path: '/a-propos',
  schema: {
    '@context': 'https://schema.org',
    '@type': 'AboutPage',
    name: 'À Propos de Supra v.',
...
export default function APropos() {
  return (
    <SeoPageTemplate
      ...
      title="À Propos de Supra v."
      subtitle="Une agence de communication 360° fondée à Marrakech"
      intro="Supra v. accompagne les marques ambitieuses à Marrakech avec une équipe complète qui relie stratégie, design, contenus, sites web, applications et automatisation IA. Nous construisons une image claire, une présence digitale crédible et des outils concrets pour transformer l'attention en clients."
      services={[
